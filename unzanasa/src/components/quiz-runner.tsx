  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <div className="mt-6 flex gap-2">
        ...
        {onExit ? <button onClick={onExit} className="btn-primary flex-1"><Home size={16} /> Done</button> : <Link href="/hub/quizzes" className="btn-primary flex-1"><Home size={16} /> Done</Link>}
      </div>
    </div>
  );
}
