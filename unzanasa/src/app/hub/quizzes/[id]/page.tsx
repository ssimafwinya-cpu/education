...
export default function QuizDetail() {
  ...
  if (!quiz) return <EmptyState icon="🔍" title="Quiz not found" action={<Link href="/hub/quizzes" className="btn-primary">Back to quizzes</Link>} />;
  ...
  return (
    <div>
      <Link href="/hub/quizzes" className="btn-ghost btn-sm mb-4 -ml-2"><ArrowLeft size={15} /> Quizzes</Link>
      ...
      <Card className="text-center">
        ...
        <div className="mx-auto mt-6 flex max-w-xs flex-col gap-2">
          ...
          <button onClick={() => router.push(`/hub/exams?quiz=${id}`)} className="btn-secondary"><Clock size={15} /> Take as timed exam</button>
        </div>
      </Card>
