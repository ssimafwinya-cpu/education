    ...
    if (queue.length === 0) {
      return (
        <EmptyState
          ...
          action={<div className="flex gap-2"><Link href="/hub/flashcards" className="btn-primary">Browse decks</Link><Link href="/hub" className="btn-secondary">Dashboard</Link></div>}
        />
      );
    }
    return (
      ...
      <div className="mx-auto max-w-md pt-8 text-center">
        <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }}>
          ...
          <div className="mt-6 flex gap-2">
            ...
            <Link href="/hub" className="btn-primary flex-1"><Home size={16} /> Dashboard</Link>
          </div>
        </motion.div>
      </div>
    );
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <div className="mb-6 flex items-center gap-3">
        <Link href="/hub" className="btn-ghost btn-sm"><Home size={16} /></Link>
