...
function NotesInner() {
  ...
  const select = (id: string) => router.push(`/hub/notes?id=${id}`, { scroll: false });
          ...
          <Card className="flex min-h-[70vh] flex-col p-0">
            <div className="flex flex-wrap items-center gap-2 border-b border-edge p-3">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <button onClick={() => { dispatch({ type: "DELETE_NOTE", id: active.id }); router.push("/hub/notes"); }} className="btn-ghost btn-sm text-rose-500"><Trash2 size={15} /></button>
              </div>
            </div>
