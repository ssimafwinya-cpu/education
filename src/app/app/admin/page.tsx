...
import {
  ...
  Search, TrendingUp, Server, AlertTriangle, Eye, Lock,
} from "lucide-react";
...
export default function AdminPage() {
  ...
  const [tab, setTab] = useState<"overview" | "users" | "moderation" | "audit">("overview");
    ...
    return (
      <div>
        ...
        <EmptyState
          ...
          action={<Link href="/app/settings" className="btn-primary"><Lock size={15} /> Go to Settings</Link>}
        />
      </div>
    );
  }
