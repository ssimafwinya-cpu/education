    ...
    <div>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2">
          ...
          {quizzes.length === 0 ? (
            <EmptyState icon="🎓" title="No exams available" description="Create quizzes with at least 3 questions to run them as timed exams." action={<Link href="/app/quizzes" className="btn-primary">Create a quiz</Link>} />
          ) : (
